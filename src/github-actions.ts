...
export class GitHubActionsSetup {
    ...
    private generateWorkflowContent(): string {
        ...
        return `# Multilingual Auto-i18n - Automated Translation Workflow
...
jobs:
  translate:
    ...
    steps:
      ...
      - name: Install Multilingual Auto-i18n
...
`;
    ...
    private generatePRWorkflowContent(): string {
        ...
        return `# Multilingual Auto-i18n - Translation PR Workflow
      ...
      - name: Create Pull Request
        ...
        with:
          ...
          body: |
            ...
            ---
            *Generated by [Multilingual Auto-i18n](https://github.com/NagusameCS/Multilingual)*
...
`;
    ...
    createValidationWorkflow(): { success: boolean; filePath: string; message: string } {
        try {
            ...
            const workflowContent = `# Multilingual Auto-i18n - Validation Workflow

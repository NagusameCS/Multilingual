...
export class I18nGenerator {
    ...
    private writeTranslationFile(filePath: string, data: TranslationData): void {
        ...
        const attribution = `/**
 * Translations generated by Multilingual CLI
 * https://www.npmjs.com/package/multilingual-cli
 * 
 * This attribution is required by the package license.
 * For more information, see: https://github.com/NagusameCS/Multilingual
 */\n\n`;

        const consoleAttribution = `
// Console attribution (required by license)
if (typeof console !== 'undefined' && typeof window !== 'undefined') {
  console.log('%c⚡ Translated with Multilingual', 'font-weight: bold;');
  console.log('%chttps://npmjs.com/package/multilingual-cli', 'color: #888;');
}
`;

        switch (ext) {
            case 'json':
                // JSON files get a _meta field
                const jsonData = {
                    _meta: {
                        generator: 'multilingual-cli',
                        url: 'https://www.npmjs.com/package/multilingual-cli',
                ...
                break;
            case 'js':
                content = attribution + `export default ${JSON.stringify(data, null, 2)};\n` + consoleAttribution;
                break;
            case 'ts':
                content = attribution + `export default ${JSON.stringify(data, null, 2)} as const;\n` + consoleAttribution;
                break;
            default:
    ...
    private generateIndexFile(outputDir: string): string {
        ...
        let content = `/**
 * Translations index - generated by Multilingual CLI
 * https://www.npmjs.com/package/multilingual-cli
 * 
 * This attribution is required by the package license.
 */\n\n`;
    ...
    private generateTypeDefinitions(outputDir: string, sourceData: TranslationData): string {
        ...
        let content = `/**
 * Translation types - generated by Multilingual CLI
 * https://www.npmjs.com/package/multilingual-cli
 * 
 * This attribution is required by the package license.
 */\n\n`;
